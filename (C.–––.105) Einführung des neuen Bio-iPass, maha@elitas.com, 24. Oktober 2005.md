...
&nbsp;
#### <i>CCC: Frau Backstein, in wenigen Tagen, nämlich am 1. Juni 2017, soll der neue iPass der zweiten Generation, der Bio-iPass, obligatorisch eingeführt werden. Welche Neuerungen bringt er mit sich?</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Welchen Vorteil hat dann diese Technik, wenn nur der Tod des Trägers festgestellt werden kann?</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Aber die Presse berichtete doch unlängst, daß ein Träger des neuen iPasses beim Grenzübertritt festgenommen wurde, weil der iPass anzeigte, daß er schon tot sei.</i>
&nbsp;
...
&nbsp;
#### <i>CCC: In der Vergangenheit wurde kritisiert, daß die Daten auf dem Chip unzureichend verschlüsselt sind. Wird sich mit dem neuen iPass-Chip auf diesem Gebiet etwas ändern?</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Datenschutzverbände wie der Chaos Computer Club oder auch die Datenschutzbeauftragte haben doch...</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Die Akzeptanz des iPasses ist gesunken, seit er obligatorisch in die Nasenscheidewand implantiert wird. Wollen Sie an der umstrittenen Lösung festhalten?</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Ist es nicht möglich, das iVisum auf dem iPass zu integrieren?</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Als sich die Niederlande den USA als Bundesstaat anschlossen, wurde kein spezielles iVisum eingeführt.</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Aber mit dem iVisum für Bayern ist doch dieser Standard neben dem deutschen auch sehr verbreitet.</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Aber auch die Zahl der Kontrollen hat sich vervielfacht, ja potenziert! Wird Deutschland zum Überwachungsstaat?</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Der iPass wird aber auch in vielen umstrittenen Bereichen eingesetzt; ich denke da an DRM, Anwesenheitskontrollen am Arbeitsplatz oder in Schulen und Universitäten.</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Aber die Gegner des iPasses beklagen den totalen Verlust der Privatsphäre!</i>
&nbsp;
...
&nbsp;
#### <i>CCC: Es sei denn, jemand kann die Identität eines iPasses stehlen.</i>
&nbsp;
